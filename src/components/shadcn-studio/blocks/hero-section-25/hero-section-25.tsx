            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center gap-8 px-4 sm:gap-16 sm:px-6 lg:gap-24 lg:px-8">
                ...
                <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <p className="text-muted-foreground max-w-4xl text-xl">
                        Build beautiful, functional websites in record time with
                        our premium UI kits. <br className="max-lg:hidden" />{" "}
                        Enjoy ready-to-use elements for a seamless user
                        experience.
                    </p>
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <Button
                            size="lg"
                            asChild
                            className="bg-primary/10 hover:bg-primary/20 text-primary rounded-lg text-base"
                        >
                            <a href="#">Learn more</a>
                        </Button>
                    </div>
                ...
                >
                    <div className="flex w-full max-w-4xl items-center justify-between max-md:hidden">
                        <div className="flex items-center gap-30">
                            ...
                            <span
                                ref={spanRef1}
                                className="size-0.5 max-md:hidden"
                            ></span>
                        </div>
                        <div className="flex items-center gap-30">
                            <span
