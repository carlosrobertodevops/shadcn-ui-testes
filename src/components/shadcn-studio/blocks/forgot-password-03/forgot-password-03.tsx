...
import ForgotPasswordForm from "@/components/shadcn-studio/blocks/forgot-password-03/forgot-password-form";
      ...
      <div className="bg-muted h-screen p-5 max-lg:hidden">
        <Card className="bg-primary relative h-full justify-between border-none py-8">
          <CardHeader className="gap-6 px-8">
            <CardTitle className="text-primary-foreground text-3xl font-bold xl:text-5xl">
          ...
          <CardContent className="relative z-1 mx-8 h-62 overflow-hidden rounded-2xl px-0">
            ...
            <div className="flex flex-col gap-5 p-6">
              <p className="line-clamp-2 pr-12 text-3xl font-bold">Follow the instructions</p>
